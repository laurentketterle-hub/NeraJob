"""Scraper for nodesk - public API with offline fallback."""
...
_OFFLINE_KEY = "NERAJOB_NODESK_OFFLINE"
_OFFLINE_JOBS = [
        ('Senior Go Developer', 'Distributed Systems Inc', 'Remote', ['go', 'grpc', 'microservices'], 'https://nodesk.co/jobs/go'),
    ]


class NodeskScraper(BaseScraper):
    """Public nodesk job board adapter."""

    name = "nodesk"
    API_URL = "https://nodesk.co/api/jobs"
